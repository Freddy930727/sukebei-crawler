...
def comment_check():
    ...
    if "comments" in driver.find_element_by_xpath(temp).get_attribute("title"):#not sure
        print("found comment,its j is"+str(j))
        temp="//tr["+k+"]/td[2]/a[2]"
...
time.sleep(10) #wait for the download finish completely,if your internet is fast enough you can just delete this line
